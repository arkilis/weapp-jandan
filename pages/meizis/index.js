...
Page({
  ...
  onLoad () {
    let that = this
    wx.request({
      url: 'https://i.jandan.net/?oxwlxojflwblxbsapi=jandan.get_ooxx_comments&page=1',
      headers: {
  ...
  loadMore:function(event){
    ...
    wx.request({
      url: 'https://i.jandan.net/?oxwlxojflwblxbsapi=jandan.get_ooxx_comments&page='+that.data.pageNum,
      header: {
        'Content-Type': 'application/json'
      },
      success (res) {
